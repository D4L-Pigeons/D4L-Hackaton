...
def get_and_save_embeddings(
    dataloader: Type[DataLoader], model: Type[pl.LightningModule], cfg: Namespace
) -> Path:
    r"""
    ...
    Args:
        ...
        cfg: Configuration namespace.
            - batch_size (int): The batch size for the data loader. Defaults to 1.
    ...
    # Open an HDF5 file
    path: Path = (
        EMBEDDINGS_PATH / f"{model.cfg.model.model_name}-{cfg.filename}-embeddings.h5"
    )
    with h5py.File(
        path,
        "w",
